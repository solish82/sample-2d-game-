...
public class PlayerInventoryTiled : MonoBehaviour
{
    // a cached reference to an instance of class PlayerInventoryDisplay
    private PlayerInventoryDisplayTiled playerInventoryDisplay;
    ...
    void Awake()
    {
        playerInventoryDisplay = GetComponent<PlayerInventoryDisplayTiled>();
    }
